...
public class MergeSortLessNodes {
  /**
  ...
  public static void main(String[] args) {
    ...
    ArrayList<Integer> ports = new ArrayList<>(Arrays.asList(8000, 8001, 8002, 8003, 8004));
    ...
    // One Branch/One Sorter
    startTime1 = System.nanoTime();
    Test(ports.get(2));
    endTime1 = System.nanoTime();

    duration1 = (endTime1 - startTime1) / 1000000; //divide by 1000000 to get milliseconds
    System.out.println("One Branch/One Sorter time: " + startTime1);
    System.out.println("One Branch/One Sorter " + endTime1);
    System.out.println("One Branch/One Sorter " + duration1 + "ms");
    System.out.println("\n\n");
    ...
    Test(ports.get(0));
     ...
     duration1 = (endTime1 - startTime1) / 1000000; //divide by 1000000 to get milliseconds
    System.out.println("Two Branch/Three Sorters time: " + startTime1);
    System.out.println("Two Branch/Three Sorters time:  " + endTime1);
    System.out.println("Two Branch/Three Sorters time:  " + duration1 + "ms");
    System.out.println("\n\n");
   ...
   // One Sorter
    ...
    duration1 = (endTime1 - startTime1) / 1000000; //divide by 1000000 to get milliseconds
    System.out.println("One Branch/One Sorter time: " + startTime1);
    System.out.println("One Branch/One Sorter time: " + endTime1);
    System.out.println("One Branch/One Sorter time: " + duration1 + "ms");
    System.out.println("\n\n");
